...
from selenium.common.exceptions import *  # usar as exceções dentro do webdriverwait
from selenium.webdriver.support.ui import WebDriverWait  # importanto o modulo wait explicito
from selenium.webdriver.chrome.service import Service as ChromeService
from time import sleep
from selenium.webdriver.support import expected_conditions as condicao_esperada  # módulo para
# esperar as condições certas para que a sequência de ações seja cumprida
...
driver, wait = iniciar_driver()  # Reparar aqui que estamos usando duas variaveis criadas acima
